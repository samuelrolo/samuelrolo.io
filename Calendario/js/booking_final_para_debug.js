document.addEventListener("DOMContentLoaded", function() {
    ...
    console.log("DEBUG: Valor inicial de coachingSummarySection:", coachingSummarySection); // DEBUG ADICIONADO
    ...
    console.log("DEBUG: Valor inicial de cvReviewSummarySection:", cvReviewSummarySection); // DEBUG JÁ ADICIONADO NA ÚLTIMA ETAPA
    ...
    if (coachingServiceButton) {
        coachingServiceButton.addEventListener("click", () => {
            console.log("DEBUG: Botão de serviço de Coaching CLICADO"); // DEBUG ADICIONADO
            showCoachingOptions();
            hideCvReviewOptions();
    ...
    if (cvReviewServiceButton) {
        cvReviewServiceButton.addEventListener("click", () => {
            console.log("DEBUG: Botão de serviço de Revisão de CV CLICADO"); // DEBUG ADICIONADO
            showCvReviewOptions();
            hideCoachingOptions();
