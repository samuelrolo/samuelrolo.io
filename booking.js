document.addEventListener("DOMContentLoaded", function() {
    ...
    const cvUploadInput = document.getElementById("cv-file-upload");
    ...
    // --- Helper Functions ---
    // const showScreen_TEMP_DEBUG = (screenToShow) => { ... }; // Removed debug function

    // --- Original showScreen function ---
    const showScreen = (screenToShow) => {
        ...
        if (screenToShow) {
            ...
            screenToShow.classList.remove("hidden"); // Explicitly remove hidden class
    ...
    // const showScreen = showScreen_TEMP_DEBUG; // Removed line assigning debug function
    ...
    selectCoachingBtn.addEventListener("click", () => {
        console.log("Coaching button clicked - Listener triggered."); // Added log
        ...
        console.log("Coaching flow element before showScreen:", coachingFlow); // Added log
    ...
    selectCvReviewBtn.addEventListener("click", () => {
        console.log("CV Review button clicked - Listener triggered."); // Added log
        currentFlow = "cv";
        resetForm(cvReviewForm);
        console.log("CV Review flow element before showScreen:", cvReviewFlow); // Added log
